...
class Grades(object):
    ...
    def addStudent(self, student):
        ...
        self.grades[student.getIdNum()] = [] #Initiate an empty list for grades
        self.isSorted = False
    ...
    def allStudents(self):
        ...
        if not self.isSorted:
            self.students.sort()
            self.isSorted = True
        return self.students[:] #return copy of list of students / this is very inefficient from memory point of view
        #An alternative of "return self.students[:]" is to use generators
